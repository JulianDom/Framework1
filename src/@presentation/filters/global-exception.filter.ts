...
export class GlobalExceptionFilter implements ExceptionFilter {
  ...
  /**
   * Maneja errores conocidos de Prisma (códigos P*)
   */
   ...
   *
   * DomainException ya no extiende HttpException, usa httpStatus directamente
   */
  ...
  /**
   * Verifica si es un error de Prisma
   */
  ...
  /**
   * Sanitiza el body para logs (oculta passwords, tokens, etc.)
   */
